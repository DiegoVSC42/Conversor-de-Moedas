const seletorMoedasEntrada = document.getElementById("seletor-moedas-entrada")
const seletorMoedasSaida = document.getElementById("seletor-moedas-saida")
...
adicionarOpcoes(seletorMoedasEntrada);
adicionarOpcoes(seletorMoedasSaida);

function adicionarOpcoes(seletor) {
  siglasMoedas.forEach(sigla => {
    const opcao = document.createElement("option");
    opcao.value = `${sigla}`;
    opcao.textContent = sigla;
    opcao.classList = "opcao"
    seletor.appendChild(opcao)
  });
}

seletorMoedasEntrada.value = "USD"
seletorMoedasSaida.value = "BRL"